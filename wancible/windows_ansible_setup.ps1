...
############################################################################
###  Paste the contents to an administrative powershell prompt,          ###
###  then run the file in same prompt                                    ###
############################################################################
#                                                                        ###
...
# Creating local user for Ansible to use
write-host "Creating User for Ansible to use" 
$secured_password = ConvertTo-SecureString $password -AsPlainText -Force
New-LocalUser -Name "$username" -Password $secured_password -FullName "$username" -Description "remote user"
